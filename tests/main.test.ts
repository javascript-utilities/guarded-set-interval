...
describe('Guarded_Set_Interval -- Happy paths', () => {
	/**
	...
	test('Guarded_Set_Interval().start() -- Works with generators', () => {
		...
		expect(interval.done).toBeFalsy();
		expect(interval.value).toEqual('Foo');

		interval.stop();
		expect(interval.done).toBeTruthy();
	});

	test('Guarded_Set_Interval().start() -- Works with iterators', () => {
		...
		expect(interval.done).toBeFalsy();
		expect(interval.value).toEqual('Bar');
